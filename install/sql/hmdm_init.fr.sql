UPDATE userroles SET name='Super Administrateur', description='Peut se connecter en tant que n''importe quel utilisateur. En mode partagé, gère les comptes d''entreprise' WHERE id=1;
UPDATE userroles SET name='Administrateur', description='Accès complet au panneau de commande' WHERE id=2;
UPDATE userroles SET name='Utilisateur', description='Accès limité au panneau de contrôle' WHERE id=3;
UPDATE userroles SET name='Observateur', description='Accès en lecture seule au panneau de contrôle' WHERE id=100;

UPDATE users SET email='fayedoun@sfp-groupe.com' WHERE id=1;

UPDATE groups SET name='Général' WHERE id=1;

UPDATE permissions SET description='Fonctions de super-administrateur pour l''ensemble du système' WHERE id=1;
UPDATE permissions SET description='Accès aux paramètres du système' WHERE id=2;
UPDATE permissions SET description='Accès aux configurations, aux applications et aux fichiers' WHERE id=3;
UPDATE permissions SET description='Accès aux appareils' WHERE id=4;
UPDATE permissions SET description='Accès à la suppression des images (plugin image)' WHERE id=100;

UPDATE plugins SET name='Images', description='Récupérer les images des appareils' WHERE id=1;
